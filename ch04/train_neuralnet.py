...
network = TwoLayerNet(input_size=### 빈칸 1 ###, hidden_size=50, output_size=10)
...
iter_per_epoch = max(train_size / ### 빈칸 2 ###, 1)

for i in range(iters_num):
    # [빈칸 3] 미니배치 획득
    # Hint: 전체 데이터 인덱스 중 'batch_size' 개수만큼 랜덤하게 뽑습니다.
    batch_mask = np.random.choice(train_size, ### 빈칸 3 ###)
    ...
    for key in ('W1', 'b1', 'W2', 'b2'):
        network.params[key] -= ### 빈칸 4 ### * grad[key]
